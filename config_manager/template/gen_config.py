...
for host in hostlist:
	...
	for ssd_id in range(1, ssd_num+1):
		tikv_strings = "{5}TiKV{0}-{1} ansible_host={2} deploy_dir=/ssd{1}/tikv/{3}/tikv-server tikv_port={4} labels=\"host={2}\"ABCXYZ".format(id, ssd_id, host, name, tikv_baseport + ssd_id, tikv_strings)
